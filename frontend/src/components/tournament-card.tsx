        ...
        <div className="mt-3 border-t border-line pt-3 sm:mt-4 sm:pt-4">
          ...
          <div className="mt-3">
            {t.registrationOpen && t.slotsLeft > 0 ? (
              ...
              <span className="flex w-full items-center justify-center rounded-input border border-line bg-white/[3%] px-5 py-2.5 text-sm font-semibold text-fg-2 transition group-hover:border-accent/40 group-hover:text-fg">
                {t.status === 'COMPLETED' ? 'View Results' : 'Details'}
              </span>
            )}
          </div>
        </div>
