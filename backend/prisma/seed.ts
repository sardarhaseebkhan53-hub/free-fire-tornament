...
async function main() {
  ...
  const settings: Array<[string, unknown, string]> = [
    ...
    ['referral.rewardAmount', 50, 'Referral reward (PKR) credited to bonus balance'],
    ['referral.qualifyingAction', 'FIRST_DEPOSIT_APPROVED', 'Action that qualifies a referral'],
